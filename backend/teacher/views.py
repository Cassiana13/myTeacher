...
from teacher.serializers import (ProfessorSerializer, CadastrarAulaSerializer, AulaSerializer, Aula)
...
class CadastrarAulaAPIView(APIView):
   def post(self, request, id , format=None):
         ...
         return Response({"message": "Houveran erros de validação", "errors": serializer.errors}, status=HTTP_400_BAD_REQUEST)
